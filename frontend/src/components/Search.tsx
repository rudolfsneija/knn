...
export function Search({ isMobile = false, onNavigate }: SearchProps) {
      ...
      <div className="flex items-center">
        ...
        <div className={`relative overflow-hidden transition-all duration-100 ease-in-out ${
          ...
          <input
            ...
            disabled={loading}
            className="w-full pl-10 pr-8 py-2 border border-gray-300 rounded-lg focus:border-gray-500 text-base sm:text-sm disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
          />
          {loading && (
