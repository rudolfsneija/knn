...
export const heroSlides: HeroSlide[] = [
  {
    ...
    description: 'Izmanto mūsu interaktīvo rīku, lai noskaidrotu nepieciešamās licences un infrastruktūru savām videonovērošanas sistēmām.',
  ...
  },
  {
    ...
    description: 'Nodrošinām visaptverošu NKDL prasību ieviešanu jūsu uzņēmumā ar profesionālu dokumentāciju un atbalstu.',
  ...
  },
  {
    ...
    description: 'Profesionālas kiberdrošības apmācības darbiniekiem un IT personālam ar fokusu uz mūsdienu kiberdrošības izaicinājumiem.',
