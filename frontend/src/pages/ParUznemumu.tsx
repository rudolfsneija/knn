      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            KNN serviss - jūsu uzticamais partneris kiberdrošības risinājumos. Latvijā reģistrēts
            uzņēmums, kas specializējas kiberdrošības risinājumos uzņēmumiem, pašnodarbinātajiem un
            privātpersonām.
          </p>
        </div>
              ...
              {sertifikati.map((sertifikats, index) => (
                <div
                  ...
                  className={`flex items-center p-4 bg-white rounded-lg shadow-sm ${
                    index === sertifikati.length - 1 && sertifikati.length % 2 !== 0
                      ? 'md:col-span-2'
                      : ''
                  }`}
                >
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {sadarbribasPartneri.map((partneris, index) => (
              <div key={index} className="bg-secondary-50 p-6 rounded-lg shadow-sm text-center">
