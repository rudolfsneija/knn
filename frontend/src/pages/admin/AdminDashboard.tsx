      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="admin-card p-6">
            <div className="flex items-center">
              <div className="p-3 rounded-full bg-admin-accent-primary/20">
                <svg
                  className="w-6 h-6 text-admin-accent-primary"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
          ...
          <div className="admin-card p-6">
            <div className="flex items-center">
              <div className="p-3 rounded-full bg-admin-accent-success/20">
                <svg
                  className="w-6 h-6 text-admin-accent-success"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="admin-card p-6">
            ...
            <p className="text-admin-text-secondary mb-4">Pārvaldiet aktualitātes un ziņas</p>
            <div className="space-y-3">
              <Link to="/admin/aktualitates" className="block admin-button-primary text-center">
          ...
          <div className="admin-card p-6">
            ...
            <p className="text-admin-text-secondary mb-4">Pārvaldiet produktu katalogu</p>
            <div className="space-y-3">
              <Link
                to="/admin/preces"
